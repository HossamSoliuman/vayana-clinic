...
<div class="mb-8">
    ...
    <h2 class="text-2xl font-bold text-text mt-4">{{ __('messages.add_provider') }}</h2>
</div>
        ...
        <form action="{{ route('admin.providers.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="email" id="email" name="email" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('email') border-red-500 @enderror" value="{{ old('email') }}" required>
                    @error('email') <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label for="license_number" class="block text-sm font-medium text-text mb-2">{{ __('messages.license') }} *</label>
                    <input type="text" id="license_number" name="license_number" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('license_number') border-red-500 @enderror" placeholder="e.g., PSY001" value="{{ old('license_number') }}" required>
                ...
                <div>
                    ...
                    <input type="number" id="years_of_experience" name="years_of_experience" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('years_of_experience') border-red-500 @enderror" value="{{ old('years_of_experience', 0) }}" min="0" max="70" required>
                ...
                <div>
                    ...
                    <input type="text" id="first_name_en" name="first_name_en" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('first_name_en') border-red-500 @enderror" value="{{ old('first_name_en') }}" required>
                ...
                <div>
                    ...
                    <input type="text" id="last_name_en" name="last_name_en" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('last_name_en') border-red-500 @enderror" value="{{ old('last_name_en') }}" required>
                ...
                <div>
                    ...
                    <input type="text" id="first_name_ar" name="first_name_ar" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('first_name_ar') border-red-500 @enderror" value="{{ old('first_name_ar') }}" dir="rtl">
                ...
                <div>
                    ...
                    <input type="text" id="last_name_ar" name="last_name_ar" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('last_name_ar') border-red-500 @enderror" value="{{ old('last_name_ar') }}" dir="rtl">
                ...
                <div>
                    ...
                    <select id="work_type" name="work_type" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('work_type') border-red-500 @enderror" required>
                        ...
                        <option value="online" {{ old('work_type') === 'online' ? 'selected' : '' }}>Online</option>
                        <option value="in_person" {{ old('work_type') === 'in_person' ? 'selected' : '' }}>In-Person</option>
                ...
                <div>
                    ...
                    <input type="number" id="session_price_inperson" name="session_price_inperson" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('session_price_inperson') border-red-500 @enderror" value="{{ old('session_price_inperson', 0) }}" step="0.01" min="0" required>
            ...
            <div>
                ...
                <textarea id="biography_en" name="biography_en" rows="4" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('biography_en') border-red-500 @enderror" required>{{ old('biography_en') }}</textarea>
            ...
            <div>
                ...
                <textarea id="biography_ar" name="biography_ar" rows="4" dir="rtl" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary @error('biography_ar') border-red-500 @enderror">{{ old('biography_ar') }}</textarea>
                ...
                <div class="space-y-2">
                    @foreach($specialties as $specialty)
                        <label class="flex items-center gap-3">
                            <input type="checkbox" name="specialties[]" value="{{ $specialty->id }}" class="rounded border-border" {{ in_array($specialty->id, old('specialties', [])) ? 'checked' : '' }}>
            ...
            <div>
                ...
                <div id="languages-container" class="space-y-2">
                    @forelse(old('languages', ['']) as $index => $language)
            ...
            <div class="flex gap-3">
                <label class="flex items-center gap-2">
                    ...
                    <input type="checkbox" name="is_verified" value="1" class="rounded border-border" {{ old('is_verified') ? 'checked' : '' }}>
                    <span class="text-sm text-text">{{ __('messages.verified') }}</span>
                </label>
                <label class="flex items-center gap-2">
                    <input type="hidden" name="is_available" value="0">
                    <input type="checkbox" name="is_available" value="1" class="rounded border-border" {{ old('is_available') ? 'checked' : '' }} checked>
                    <span class="text-sm text-text">{{ __('messages.available') }}</span>
                </label>
            </div>

            <div class="flex gap-3 pt-4 border-t border-border">
                <button type="submit" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-hover transition-colors">{{ __('messages.create') }}</button>
